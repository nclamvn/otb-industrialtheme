...
const TYPE_CONFIG = {
  brands: {
    ...
    columns: [
      ...
      { key: 'groupBrand', label: 'Group', render: (v) => v?.name || v || '-' },
      { key: 'isActive', label: 'Status', render: (v) => v !== false ? 'Active' : 'Inactive', badge: true },
    ],
  ...
  skus: {
    ...
    columns: [
      { key: 'skuCode', label: 'SKU Code', width: '140px', mono: true },
      { key: 'productName', label: 'Product Name' },
      { key: 'productType', label: 'Category', width: '150px' },
      { key: 'color', label: 'Color', width: '120px' },
      { key: 'theme', label: 'Theme', width: '120px' },
      { key: 'srp', label: 'SRP', width: '120px', render: (v) => v ? formatCurrency(v) : '-', mono: true },
    ],
  ...
  categories: {
    ...
    columns: [
      ...
      { key: 'gender', label: 'Gender', render: (v) => v?.name || v || '-' },
      { key: 'subCategories', label: 'Sub-Categories', render: (v) => Array.isArray(v) ? `${v.length} items` : '-' },
      { key: 'isActive', label: 'Status', render: (v) => v !== false ? 'Active' : 'Inactive', badge: true },
    ],
    searchFields: ['code', 'name'],
  },
  subcategories: {
    ...
    columns: [
      ...
      { key: 'parent', label: 'Parent Category', render: (v) => v?.name || '-' },
      { key: 'isActive', label: 'Status', render: (v) => v !== false ? 'Active' : 'Inactive', badge: true },
    ],
    searchFields: ['code', 'name'],
  },
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-medium text-sm font-['Montserrat'] transition-all ${
              darkMode
                ...
                : 'text-[#666666] hover:text-[#8A6340] hover:bg-[rgba(215,183,151,0.15)] border border-[#2E2E2E]/20'
            }`}
          >
      ...
      <div className={`rounded-xl border shadow-sm p-4 ${
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className={`text-sm font-semibold font-['Montserrat'] ${darkMode ? 'text-[#F2F2F2]' : 'text-[#0A0A0A]'}`}>Search</span>
          </div>
            ...
            <input
              ...
              className={`w-full pl-10 pr-10 py-2.5 border rounded-lg text-sm font-['Montserrat'] transition-all focus:outline-none focus:ring-2 focus:ring-[#D7B797] ${
                darkMode
                  ...
                  : 'bg-white border-[#2E2E2E]/20 text-[#0A0A0A] placeholder-[#999999]'
              }`}
            />
            {searchTerm && (
              <button
      ...
      <div className={`rounded-xl border shadow-sm overflow-hidden ${
        ...
        {loading ? (
          <div className="p-16 text-center">
            ...
            <p className={`text-sm font-['Montserrat'] ${darkMode ? 'text-[#999999]' : 'text-[#666666]'}`}>Loading data...</p>
          </div>
        ) : error ? (
          <div className="p-16 text-center">
                    ...
                    <tr
                      ...
                      className={`border-t transition-colors ${
                        darkMode
                          ...
                          : 'border-[#2E2E2E]/10 hover:bg-[rgba(215,183,151,0.06)]'
                      }`}
                    >
