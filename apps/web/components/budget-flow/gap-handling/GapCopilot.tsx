    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b dark:border-neutral-800 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 border-2 border-border shadow-orange-200 dark:shadow-orange-900/30">
      ...
      >
        <TabsList className="grid w-full grid-cols-2 p-1 m-4 mb-0 bg-muted dark:bg-neutral-800 rounded-lg">
          <TabsTrigger
            value="suggestions"
            className="flex items-center gap-2 data-[state=active]:bg-card dark:data-[state=active]:bg-neutral-900 data-[state=active]:border border-border"
          >
      ...
      {/* Footer */}
      <div className="p-4 border-t dark:border-neutral-800 bg-muted/50 dark:bg-neutral-900">
