...
export type CostCurrency = 'USD' | 'GBP' | 'EUR' | 'SGD';
...
export interface CostingBreakdown {
  ...
  wholesaleSGD?: number;          // Wholesale price (SGD)
  rrpSGD?: number;                // R.R.P (SGD)
...
// Import tax rates by product category (from Excel)
